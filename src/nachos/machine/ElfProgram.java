...
public class ElfProgram {
	...
	private EnumSet<ElfProgramFlag> flags;
	...
	public ElfProgram(Elf object, byte programHeaderData[]) {
		this.object = object;
        privilege.doPrivileged(new Runnable() {
            public void run() { flags = EnumSet.noneOf(ElfProgramFlag.class); }
        });
